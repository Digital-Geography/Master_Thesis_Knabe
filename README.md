...
Spatial habitat suitability was predicted using a binomial generlaized additive model (GAM) while daily mosquito counts were predicted using a negative binomial generlaized additive mixed model (GAMM). To predict spatial habitat suitability two approaches were tested to account for biased observation data due to heterogeneous sampling effort:  
